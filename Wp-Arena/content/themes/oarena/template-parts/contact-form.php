...
if(isset($_POST['submitted'])) {
	...
	//Vérifier si le formulaire à été rempli
	...
	if(trim($_POST['checking']) !== '') {
		...
		//Vérifiez que le champ de nom n'est pas vide
		...
		//Assurez qu'une adresse e-mail valide est envoyée
		...
		//Vérifiez que les commentaires ont été entrés	
		...
		//S'il n'y a pas d'erreur, envoyez l'e-mail

		if(!isset($hasError)) {

			$emailTo = 'arenambj@gmail.com';
